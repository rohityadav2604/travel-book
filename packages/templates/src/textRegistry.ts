...
const registry: Record<string, EditableTextFieldDef[]> = {
  ...
  DestinationQuote: [
    { key: "quote", label: "Quote", defaultValue: "Not all those who wander are lost —\nsome of us are simply taking\nthe long way home.", multiline: true },
    { key: "attribution", label: "Attribution", defaultValue: "— found in a guesthouse ledger" },
    { key: "stampCity", label: "Stamp city", defaultValue: "BKK" },
    { key: "pageNumber", label: "Page number", defaultValue: "— fin —" },
  ],
  Ephemera: [
  ...
  DestinationBackCover: [
    { key: "returnLabel", label: "Return label", defaultValue: "— RETURN TO —" },
    { key: "returnName", label: "Return name", defaultValue: "the one who wandered" },
    { key: "returnAddress", label: "Return address", defaultValue: "c/o the kitchen table\na small flat by the river\nsomewhere quiet, again", multiline: true },
    { key: "sentiment", label: "Sentiment", defaultValue: "And so we came home,\nfull of weather & light\n& the smell of elsewhere.", multiline: true },
    { key: "colophonLabel", label: "Colophon label", defaultValue: "colophon" },
    { key: "colophon", label: "Colophon", defaultValue: "Bound in this city. Set in Bodoni Moda & Source Serif 4. Printed on paper the color of old postcards — this copy belongs to you.", multiline: true },
    { key: "brand", label: "Footer brand" },
    { key: "coordinates", label: "Coordinates" },
    { key: "passportCity", label: "Passport city", defaultValue: "THE END" },
    { key: "passportDate", label: "Passport date", defaultValue: "MCMLXXIV" },
  ],
