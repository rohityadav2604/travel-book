...
import "./themes/destination/index";
  ...
  return (
    <AdjustmentContext.Provider value={{ adjustments: adjustments ?? {}, onAdjust }}>
      <div className="relative h-full w-full">
        <ThemeComposer templateName={templateName} slots={slots} captions={captions} theme={theme} adjustments={adjustments} onAdjust={onAdjust} />
        {note && (
