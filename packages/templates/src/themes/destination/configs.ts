...
export const bangkokThemeConfig: DestinationThemeConfig = {
  ...
  assetKit: {
    landmark: "riverTemple",
    pattern: "goldRiver",
    ticketStyle: "boat",
    routeStyle: { variant: "river", marker: "lotus" },
    ephemera: {
      primaryTicket: "Chao Phraya boat",
      secondaryTicket: "night market bill",
      receiptTitle: "flower market",
      receiptLines: ["jasmine garland", "mango rice", "tuk-tuk fare"],
      stamp: "gold leaf",
      note: "humid evening, temple bells, neon after rain",
      smallLabel: "soi memory",
      tape: "#d9476f",
      tapeAlt: "#3f8f8a",
      tab: "#d9a441",
      paper: "#f4d4ad",
    ...
    photoTreatment: {
      coverFilter: "saturate(.82) contrast(1.02) sepia(.16) brightness(.78)",
      heroFilter: "saturate(.84) contrast(1.08) sepia(.08) brightness(.7)",
      scrapbookFilter: "saturate(.9) contrast(.98) sepia(.14) brightness(.96)",
      mapFilter: "saturate(.86) contrast(.98) sepia(.12) brightness(.95)",
      overlay: "linear-gradient(180deg, rgba(217,164,65,.08), rgba(217,71,111,.16))",
    },
  },
...
export const destinationThemeConfigs: DestinationThemeConfig[] = [
  bangkokThemeConfig,
  {
    ...
    assetKit: {
      landmark: "ironSeine",
      pattern: "bistroPoster",
      ticketStyle: "metro",
      routeStyle: { variant: "seine", marker: "bridge" },
      ephemera: {
        primaryTicket: "metro carnet",
        secondaryTicket: "terrace receipt",
        receiptTitle: "cafe du soir",
        receiptLines: ["deux cafes", "tarte citron", "table 14"],
        stamp: "rive gauche",
        note: "rain on zinc tables, red awnings, bridge light",
        smallLabel: "blue hour",
        tape: "#a33a35",
        tapeAlt: "#2f6173",
        tab: "#c79547",
        paper: "#f6e8d2",
      ...
      photoTreatment: {
        coverFilter: "saturate(.72) contrast(1.02) sepia(.18) brightness(.8)",
        heroFilter: "saturate(.7) contrast(1.05) sepia(.12) brightness(.72)",
        scrapbookFilter: "saturate(.78) contrast(.98) sepia(.17) brightness(.98)",
        mapFilter: "saturate(.76) contrast(.98) sepia(.14) brightness(.96)",
        overlay: "linear-gradient(180deg, rgba(47,97,115,.1), rgba(163,58,53,.14))",
      },
    },
  ...
  },
  {
    ...
    assetKit: {
      ...
      pattern: "cobaltTile",
      ticketStyle: "rail",
      routeStyle: { variant: "railCoast", marker: "sun" },
      ephemera: {
        primaryTicket: "renfe regional",
        secondaryTicket: "plaza tab",
        receiptTitle: "mercado central",
        receiptLines: ["orange peel", "almonds", "late supper"],
        stamp: "costa luz",
        note: "tiles, train windows, hot stone after sunset",
        smallLabel: "saffron hour",
        tape: "#245f8f",
        tapeAlt: "#cf4b2c",
        tab: "#d7a329",
        paper: "#f7d6a8",
      ...
      photoTreatment: {
        coverFilter: "saturate(.9) contrast(1.04) sepia(.14) brightness(.8)",
        heroFilter: "saturate(.86) contrast(1.08) sepia(.1) brightness(.74)",
        scrapbookFilter: "saturate(.92) contrast(1) sepia(.13) brightness(.97)",
        mapFilter: "saturate(.86) contrast(1) sepia(.12) brightness(.96)",
        overlay: "linear-gradient(180deg, rgba(215,163,41,.1), rgba(36,95,143,.14))",
      },
    },
